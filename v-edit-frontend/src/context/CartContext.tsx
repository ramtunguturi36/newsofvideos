...
export type CartItem =
  ...
  | { id: string; type: "video-content"; title: string; price: number }
  | { id: string; type: "video-folder"; title: string; price: number }
  | { id: string; type: "audio-content"; title: string; price: number }
  | { id: string; type: "audio-folder"; title: string; price: number };
