    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center p-3 bg-gradient-to-br from-purple-100 to-blue-100 rounded-2xl mb-6">
          ...
          <h1 className="text-5xl font-bold bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">
            Video Folder Collections
          </h1>
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
            Purchase complete video folder collections and get instant access to
            all videos
          </p>
          <Button
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                {selectedFolder?.category && (
                  <div className="bg-indigo-50 p-4 rounded-lg">
                    <div className="text-sm text-indigo-600 mb-1">Category</div>
