    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <main className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <MarketplaceHeader
            icon={Image}
            title="Picture Collections Marketplace"
            subtitle="Purchase complete picture folder collections and get instant access"
          ...
          {folders.length === 0 ? (
            <div className="text-center py-20 bg-white/90 backdrop-blur-lg rounded-2xl border border-slate-200/50">
              ...
              <p className="text-slate-500">
                Check back later for new picture folder collections
              </p>
            </div>
          ) : (
