    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-red-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center p-3 bg-gradient-to-br from-orange-100 to-pink-100 rounded-2xl mb-6">
            <FolderIcon className="h-12 w-12 text-orange-600" />
          </div>
          <h1 className="text-5xl font-bold bg-gradient-to-r from-orange-600 via-pink-600 to-red-600 bg-clip-text text-transparent mb-4">
            Audio Folder Collections
          </h1>
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
            Purchase complete audio folder collections and get instant access to
            all audio tracks
          </p>
          <Button
